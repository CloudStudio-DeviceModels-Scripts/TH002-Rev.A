...
# Parsing Script – TH002 - Rev. A

This **Parsing** script is designed for the **TH002** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – TH002 Rev. A

Este script de **Parsing** está diseñado para el modelo **TH002** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
